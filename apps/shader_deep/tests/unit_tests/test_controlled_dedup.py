...
from shader_deep.analysis.controlled_replay import _write_summary
...
class ControlledDedupTests(GenerationFixture):
    ...
    def test_three_accepted_decisions_use_canonical_owner_and_keep_distinct_mechanisms(self) -> None:
        ...
        with patch.multiple("shader_deep.analysis.controlled", FEATURE_PROMPT="feature-criteria", CANDIDATE_PROMPT="candidate-criteria"):
            self.run_works()
