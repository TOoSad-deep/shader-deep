...
from shader_deep.agents.generation import GenerationIncompleteError, generate_shader, generate_task, run_generation
...
from tests.unit_tests.test_context import BASE_CODE, PNG
...
class GenerationTests(GenerationFixture):
    def setUp(self) -> None:
        ...
        renderer = patch("shader_deep.tools.render.WebGL2Renderer", ThreadBoundRenderer)
        renderer.start()
