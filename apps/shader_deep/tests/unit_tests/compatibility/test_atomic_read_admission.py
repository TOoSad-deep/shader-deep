...
from shader_deep.compatibility.ondemand.session import ExplorationSession, RepairContextError
...
from shader_deep.runtime.budgets import remaining_material_chars
