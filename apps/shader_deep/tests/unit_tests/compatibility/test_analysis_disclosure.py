...
from shader_deep.domain.legacy import AnalysisSummary, AnalysisTaskRequest, LensReport, SourceRef, VisualDecomposition, VisualElement, VisualMapping
...
from tests.unit_tests.compatibility.test_analysis import draft_batch, report_arguments
from tests.unit_tests.compatibility.test_analysis_evidence import measurement, pixels
from tests.unit_tests.fixtures._analysis_fixture import raw_context_payload, run_legacy_analysis, run_legacy_analysis_task
...
class AnalysisDisclosureTests(GenerationFixture):
    ...
    def test_complete_sections_accumulate_but_truncated_or_oversized_reads_do_not(self) -> None:
        ...
        with patch("shader_deep.compatibility.analysis.report_files.MAX_REPORT_RESPONSE_CHARS", 200):
