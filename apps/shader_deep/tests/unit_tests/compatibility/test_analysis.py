...
from shader_deep.domain.legacy import AnalysisTaskRequest, LensReport
...
from tests.unit_tests.agents.test_context import PNG
from tests.unit_tests.fixtures._analysis_fixture import AnalysisFixture, context_payload, run_legacy_analysis
