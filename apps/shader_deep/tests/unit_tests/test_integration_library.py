...
from shader_deep.analysis.exploration import Candidate, ElementScope, Requirement
from shader_deep.analysis.integration import IntegrationDecision, MergeDecision, OutlineIssueDecision
