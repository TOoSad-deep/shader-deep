...
class AnalysisConfigTests(TestCase):
    def setUp(self) -> None:
        ...
        default = patch("shader_deep.workflows.configuration.DEFAULT_CONFIG", self.config)
        default.start()
    ...
    def test_bundled_config_is_independent_of_working_directory(self) -> None:
        bundled = Path(analysis_config.__file__).resolve().parents[1] / "resources" / "analysis.yaml"
        ...
        with patch("shader_deep.workflows.configuration.DEFAULT_CONFIG", bundled):
    ...
    def test_cli_explicit_config_and_overrides_preserve_false_and_zero(self) -> None:
        ...
        with (
            ...
            patch("shader_deep.cli.analysis.run_analysis", return_value=outcome) as run,
    ...
    def test_invalid_cli_config_fails_before_model_invocation(self) -> None:
        ...
        with (
            ...
            patch("shader_deep.cli.analysis.run_analysis") as run,
