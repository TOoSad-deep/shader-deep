...
from shader_deep.analysis.exploration import ExplorationReport, PossibilityLibrary
from shader_deep.analysis.exploration_prompts import EXPLORATION_PROMPT, INTEGRATION_PROMPT, OUTLINE_PROMPT
...
class OnDemandCompatibilityTests(GenerationFixture):
    def setUp(self) -> None:
        ...
        session = patch("shader_deep.agents.analysis.ManagedIntegrationSession", ExplorationSession)
        session.start()
