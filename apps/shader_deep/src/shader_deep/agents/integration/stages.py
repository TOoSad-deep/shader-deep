"""独立整合子 Agent: 有界发现小组, 受限执行, 独立复核初稿问题."""
...
from shader_deep.agents.integration.contracts import ControlledWork
from shader_deep.agents.integration.worker import IntegrationWorker
from shader_deep.domain.outline import OutlineReview, VerifyOutlineReview, require_issue_ids, review_error, revised_outline
...
class IntegrationProgram(IntegrationWorker):
    """默认入口和冻结回放共用的独立整合角色; 每个阶段及工作只执行一次."""
