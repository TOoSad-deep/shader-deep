...
from shader_deep.domain.legacy import AnalysisSummary, LensReport
from shader_deep.domain.library.models import ExplorationReport, PossibilityLibrary
from shader_deep.domain.library.validation import validate_exploration, validate_library
from shader_deep.domain.references import report_catalog

if TYPE_CHECKING:
    from collections.abc import Mapping

    from shader_deep.domain.evidence import ImageRegion
    ...
    from shader_deep.domain.tasks import BlackboardState, ResultRecord, TaskRecord
