...
from shader_deep.compatibility.analysis.context import build_analysis_context, lens_result_ids
from shader_deep.compatibility.analysis.presets import PRESET_LENSES
from shader_deep.compatibility.analysis.report_files import AnalysisReportFiles
from shader_deep.compatibility.analysis.worker import run_lens
from shader_deep.domain.blackboard import add_result, add_task
from shader_deep.domain.evidence import MeasurementRequest  # noqa: TC001  # 工具参数结构需要在运行时解析.
from shader_deep.domain.legacy import AnalysisSummary, AnalysisTaskRequest, LensConfig, SourceRef, VisualDecomposition
from shader_deep.domain.references import unlinked_interpretations
...
from shader_deep.runtime.execution import AnalysisExecution, ToolFeedback
...
if TYPE_CHECKING:
    ...
    from shader_deep.domain.legacy import VisualMapping
    from shader_deep.domain.tasks import BlackboardState
    from shader_deep.runtime.submissions.handler import SubmissionReply
