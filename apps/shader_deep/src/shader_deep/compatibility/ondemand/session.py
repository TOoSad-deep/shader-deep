...
from shader_deep.compatibility.analysis.context import _evidence_payload
...
from shader_deep.domain.errors import AnalysisValidationError, StaleMaterialError as StaleMaterialError
from shader_deep.domain.evidence import MeasurementRequest  # noqa: TC001  # 工具 schema 在运行时解析参数类型.
from shader_deep.domain.legacy import LensConfig
from shader_deep.domain.library.context_views import bounded_context_page
...
from shader_deep.domain.library.models import ExplorationReport, VisualOutline, compact_data
from shader_deep.domain.library.queries import ListComparisonWorkInput, ListLibraryInput, ReadLibraryInput, list_library, select_library
...
from shader_deep.runtime.budgets import RequestBudgetError, check_request, remaining_material_chars
