...
from shader_deep.analysis.exploration_session import ExplorationSession, StaleMaterialError
...
from shader_deep.analysis.schemas import AnalysisValidationError, Text  # Pydantic 运行时解析文本约束.
...
if TYPE_CHECKING:
    ...
    from shader_deep.analysis.materials import ComparisonGroup
