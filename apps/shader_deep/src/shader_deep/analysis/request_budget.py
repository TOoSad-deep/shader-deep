...
from shader_deep.analysis.types import AnalysisLimitError
...
def estimated_tokens(text_chars: int, images: int, options: AnalysisOptions) -> int:
...
def remaining_material_chars(prompt: str, context: BaseMessage, tools: list[BaseTool], options: AnalysisOptions) -> int:
...
def check_request(request: ModelRequest, tools: list[BaseTool], options: AnalysisOptions) -> None:
