...
from shader_deep.analysis.controlled import ControlledWork
from shader_deep.analysis.exploration_session import ExplorationSession
from shader_deep.analysis.integration_worker import IntegrationWorker
...
class IntegrationSubagent(IntegrationWorker):
