...
from shader_deep.analysis.exploration import ExplorationReport, Feature, Relation, Sketch, validate_exploration
from shader_deep.analysis.exploration_prompts import EXPLORATION_PROMPT
from shader_deep.analysis.loop import AnalysisLoop
from shader_deep.analysis.request_budget import check_request
from shader_deep.analysis.submissions import SubmissionHandler, SubmissionReply
from shader_deep.analysis.transport import configure_analysis_model
from shader_deep.analysis.types import AnalysisExecution, AnalysisLimitError
from shader_deep.config import build_model
from shader_deep.context.exploration import build_exploration_context
...
if TYPE_CHECKING:
    ...
    from shader_deep.analysis.events import EventCallback, EventLog
